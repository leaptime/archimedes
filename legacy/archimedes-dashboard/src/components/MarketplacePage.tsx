...
import { 
  Search, Sparkles, TrendingUp, Clock, Star, 
...
export function MarketplacePage() {
  ...
  const featuredModules = mockModules.filter(m => m.rating >= 4.8 && m.status !== "coming-soon").slice(0, 3);
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-sidebar via-sidebar to-primary/20 px-6 py-12 lg:py-16">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg text-sidebar-foreground/80 mb-8 max-w-2xl mx-auto">
              Discover powerful modules from official and third-party developers. 
              Mix and match to create your ideal business solution.
            </p>
          </motion.div>
      ...
      <div className="p-6 space-y-10">
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-foreground">Featured Modules</h2>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent-foreground/20 to-accent flex items-center justify-center">
                <Filter className="w-5 h-5 text-accent-foreground" />
              </div>
              <div>
                <h2 className="text-xl font-semibold text-foreground">Browse by Category</h2>
                <p className="text-sm text-muted-foreground">Find modules for every business need</p>
              </div>
            </div>
          </div>

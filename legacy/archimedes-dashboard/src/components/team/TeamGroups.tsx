...
import { 
  Plus, MoreHorizontal, Users, Folder, Settings, Trash2, Edit2
} from "lucide-react";
...
export const TeamGroups = ({ groups, members, availableModules }: TeamGroupsProps) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Organize team members into groups for easier permission management</p>
        </div>
                  ...
                  {colorOptions.map((color) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full ${color.class} transition-all ${
                        newGroup.color === color.name ? "ring-2 ring-offset-2 ring-primary" : ""
                      }`}
                    />
                  ))}
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-lg bg-${group.color}-500/20 flex items-center justify-center`}>
                    <Folder className={`w-5 h-5 text-${group.color}-500`} />
                  </div>
                  <div>
        ...
        {groups.length === 0 && (
          ...
          >
            ...
            <h4 className="font-medium text-foreground mb-1">No groups yet</h4>
            <p className="text-sm text-muted-foreground mb-4">
              Create groups to organize team members and manage permissions efficiently
            </p>

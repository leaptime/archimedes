...
import { ModuleCategory, CATEGORY_LABELS, CATEGORY_COLORS } from "@/types/module";
...
export function CategoryCard({ category, icon, count, index, isSelected, onClick }: CategoryCardProps) {
